...
<body>
    ...
    <h1 class="heading">Deposit Your Amount Over Here!</h1>


    <section>
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="px-4 py-8 sm:px-10">
                <form class="space-y-6" action="deposit_db.php" method="POST">
                    <div>
